...
export const CARD_DEFINITIONS: CardDefinition[] = [
  ...
  },
  {
    ...
    category: "Residential",
    cost: 3,
    baseYield: { gold: 0, population: 3, happiness: 0, pollution: 0 },
    upkeep: { gold: -1 },
    adjacencyRules: [
  ...
  },
  {
    ...
    category: "Residential",
    cost: 5,
    baseYield: { gold: 1, population: 6, happiness: -2, pollution: 0 },
    upkeep: { gold: -2 },
    adjacencyRules: [
  ...
  },
  {
    ...
    category: "Industry",
    cost: 4,
    baseYield: { gold: 4, population: 0, happiness: -1, pollution: 4 },
    adjacencyRules: [
  ...
  },
  {
    ...
    category: "Industry",
    cost: 6,
    baseYield: { gold: 6, population: 0, happiness: -2, pollution: 7 },
    adjacencyRules: [
  ...
  },
  {
    ...
    category: "Services",
    cost: 4,
    baseYield: { gold: 0, population: 1, happiness: 2, pollution: 0 },
    upkeep: { gold: -1 },
    adjacencyRules: [{ neighborCategory: "Residential", effect: { population: 1 } }],
  },
  {
    id: "market",
    name: "Market",
    category: "Services",
    cost: 4,
    baseYield: { gold: 2, population: 0, happiness: 1, pollution: 0 },
    upkeep: { gold: -1 },
    adjacencyRules: [
      { neighborCategory: "Residential", effect: { gold: 1 } },
